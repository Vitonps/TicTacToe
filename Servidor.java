...
public class Servidor {
    ...
    private static class Jogador {
        ...
        // Metodo para fechar a conexao do jogador
    ...
    private static class JogadorIA extends Jogador implements Runnable {
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    // Verifica se a escolha do jogador foi "exit" e desconecta do servidor
                    if (jogadaJogador.equalsIgnoreCase("exit")) {
                        saida.writeObject("Você saiu do jogo, desconectando...");
                        saida.flush();
                        break;
                    }
                    // Logica para mostrar a escolha aleatoria da IA e enviar ao cliente
                    String jogadaIA = escolherJogadaIA();
                    resultado = determinarResultado(jogadaJogador.toLowerCase(), jogadaIA);
        ...
        // Logica da jogada aleatoria da IA
        private String escolherJogadaIA() {
            String[] jogadas = {"pedra", "papel", "tesoura"};
            int escolha = (int) (Math.random() * jogadas.length);
            return jogadas[escolha];
        }

        // Logica da escolha da jogada
